...
`);
    ...
    $(document).ready(function () {
        ...
        const $legacy = $(SELECTORS.modelUrl);
        if ($legacy.length) {
        ...
        const rawStr = $(SELECTORS.configJson).val();
        ...
        $(SELECTORS.basePrice).on("input", function () {
            CFG.basePrice = getBasePrice();
            syncHiddenJSON();
        });
        ...
        syncHiddenJSON();
        ADMIN_VIEWER = document.querySelector(SELECTORS.adminViewer);
